...
public class XPaymentRestClientConfig {
    ...
    RestTemplate xpaymentRestTemplate(
        @Value("${app.x-payment-api.client.username}")
        String username,
        @Value("${app.x-payment-api.client.password}")
        String password,
        @Value("${app.x-payment-api.client.account}")
        String xPayAccount) {
    ...
    ApiClient xpaymentApiClient(
        @Value("${app.x-payment-api.client.url}")
        String xPaymentUrl,
        RestTemplate xpaymentRestTemplate) {
